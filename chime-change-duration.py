"""Sample script that uses the ring-doorbell API to change the in-home chime duration."""
...
async def main() -> None:
    ...
    for doorbell in list(doorbells):
        ...
        while True:
            ...
            user_choice = input("Please select a chime duration (0-10): ")
            ...
            try:
                ...
                if 0 <= user_choice <= 10:
                    print('Changing In-Home Chime Duration to %s' % user_choice)
                    await doorbell.async_set_existing_doorbell_type_duration(user_choice)
                    time.sleep(2)
                    print()
                ...
                print("Invalid input. Please choose a number between 0 and 10.")
