...
async def main() -> None:
    ...
    for doorbell in list(doorbells):
        ...
        while True:
            ...
            user_choice = input("Please enter True or False:")

            # Check if the input is valid
            if user_choice == "True":
                user_choice = True
                print('Changing In-Home Chime Status to %s' % user_choice)
                await doorbell.async_set_existing_doorbell_type_enabled(user_choice)
                time.sleep(2)
                print()
